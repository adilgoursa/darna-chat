...
class ChatActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // For testing, you can use token-less mode or get a temporary token
    ...
    private fun startVoiceCall() {
        val intent = android.content.Intent(this, VoiceCallActivity::class.java)
        intent.putExtra(VoiceCallActivity.EXTRA_OTHER_UID, otherUid)
        intent.putExtra(VoiceCallActivity.EXTRA_OTHER_NAME, binding.tvChatWithName.text.toString())
        intent.putExtra(VoiceCallActivity.EXTRA_APP_ID, AGORA_APP_ID)
        // For now, use empty token (requires token-less mode on Agora Console)
        // Later, generate a real token from your backend
        intent.putExtra(VoiceCallActivity.EXTRA_TOKEN, "")
        // Use chatId as channel name for Agora
