...
import com.adil.chatapp.FullscreenImageActivity
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (message.type) {
            MessageType.IMAGE -> {
                ...
                // Click listener to open image fullscreen
                ivImage.setOnClickListener {
                    val intent = Intent(ivImage.context, FullscreenImageActivity::class.java)
                    intent.putExtra(FullscreenImageActivity.EXTRA_IMAGE_BASE64, message.mediaUrl)
